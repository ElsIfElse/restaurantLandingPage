...
const buttonVariants = cva(
  "inline-flex items-center border-none justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:ring-offset-stone-950",
  {
    variants: {
      variant: {
        ...
        ghost: "hover:bg-stone-700 hover:bg-opacity-50 dark:hover:bg-stone-800 dark:hover:text-stone-50",
